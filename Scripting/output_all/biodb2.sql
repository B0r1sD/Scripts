...
/*!50013 DEFINER=`boris`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view1` AS select `modorg`.`id` AS `id`,`modorg`.`class_id` AS `class_id`,`modorg`.`genus` AS `genus`,`modorg`.`species` AS `species`,`modorg`.`nchr` AS `nchr`,`modorg`.`gsize` AS `gsize`,`modorg`.`draft` AS `draft` from `modorg` */;
...
-- Dump completed on 2023-01-08 17:20:50
